                            ...
                            <v-row>
                                <v-col cols="12" md="6">
                                    <v-card-text class="mt-12">
                                        ...
                                        <v-row align="center" justify="center">
                                            <v-col cols="12" sm="8">
                                                <v-text-field v-model="payload.email" label="Email" outlined dense
                                                    color="blue" autocomplete="false" class="mt-16" />
                                                <v-text-field v-model="payload.password" label="Password" outlined dense
                                                ...
                                                <v-btn color="blue" dark block tile @click="handleSubmit"
                                    ...
                                    <div style="text-align: center; padding: 180px 0;">
                                        <v-card-text class="white--text">
                                            ...
                                            <h6 class="text-center">Let's get you all set up so you can start creating
                                                your first onboarding experience</h6>
                                        </v-card-text>
